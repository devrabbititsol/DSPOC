 ...
 async calLength(typeId, event){
  ...
  render() {
	...
	<div className="container">
		...
		<a href="" data-toggle="modal" data-target=".address-modal"><i className="mdi mdi-map-search-outline"></i></a></div>
...
<div className="modal fade address-modal modal-main" tabIndex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div className="modal-dialog modal-lg">
    <div className="modal-content">
		
		<div className="modal-header">
        <h5 className="modal-title" id="">Select Address and Amenities</h5>
		...
		<div className="modal-body">
			...
			<div className="address-main mb-5">
				<div className={this.state.filterAddress == 1 ? "address-widget address-widget_active" :"address-widget"} onClick={this.filterAddressActive.bind(this, 1)}>
					<div className="widget-title">
						<i className="mdi mdi-briefcase"></i> WORK ADDRESS
					</div>
					
					<div className="address-sub">
						<ul>
							<li><i className="mdi mdi-map-marker"></i> 7950 Dublin Blvd., Suite 314, Dublin, CA 94568</li>
							<li><i className="mdi mdi-cellphone-android"></i> +1-650-352-8686</li>
							<li><i className="mdi mdi-email"></i> info@suiteamerica.com</li>
						</ul>
					</div>
				</div>
				
				
				<div className={this.state.filterAddress == 2 ? "address-widget address-widget_active" :"address-widget"}  onClick={this.filterAddressActive.bind(this, 2)}>
					<div className="widget-title widget-title-active">
						<i className="mdi mdi-home-map-marker"></i> TEMPORARY ADDRESS
					</div>
					
					<div className="address-sub">
						<ul>
							<li><i className="mdi mdi-map-marker"></i> 555 San Antonio Rd, Mountain View, CA 95762</li>
							<li><i className="mdi mdi-cellphone-android"></i> +1-650-352-9999</li>
							<li><i className="mdi mdi-email"></i> info@suiteamerica.com</li>
						</ul>
					</div>
				</div>
        ...
        <button type="button" className="btn btn-sa" data-dismiss="modal">Search</button>
      </div>
